...
*/
    ...
    uint32_t fail = 0;    
        std::cout<<"================================="<<std::endl;
        if(j==0) {
            if(op == 0)      std::cout<<" Case: pINF + pINF "<<std::endl;
            else if(op == 1) std::cout<<" Case: pINF - pINF "<<std::endl;
            else if(op == 2) std::cout<<" Case: pINF * pINF "<<std::endl;
            std::uniform_real_distribution<> dist_1a(65505,65504*4);
            std::uniform_real_distribution<> dist_1b(65505,65504*4);
            dist1 = dist_1a;
            dist2 = dist_1b;
        } else if(j == 1) {
            if(op == 0)      std::cout<<" Case: pINF + nINF "<<std::endl;
            else if(op == 1) std::cout<<" Case: pINF - nINF "<<std::endl;
            else if(op == 2) std::cout<<" Case: pINF * nINF "<<std::endl;            
            std::uniform_real_distribution<> dist_1a(65505,65504*4);
            std::uniform_real_distribution<> dist_1b(-65505.0*4,-65505.0);
            dist1 = dist_1a;
            dist2 = dist_1b;            
        } else if(j == 3) {
            if(op == 0)      std::cout<<" Case: nINF + nINF "<<std::endl;
            else if(op == 1) std::cout<<" Case: nINF - nINF "<<std::endl;
            else if(op == 2) std::cout<<" Case: nINF * nINF "<<std::endl;            
            std::uniform_real_distribution<> dist_1a(-65505.0*4,-65505.0);
            std::uniform_real_distribution<> dist_1b(-65505.0*4,-65505.0);
            dist1 = dist_1a;
            dist2 = dist_1b;            
        } else if(j == 4) {
            if(op == 0)      std::cout<<" Case: Normal (-65505,65505) + Normal (-65505,65505)"<<std::endl;
            else if(op == 1) std::cout<<" Case: Normal (-65505,65505) - Normal (-65505,65505)"<<std::endl;
            else if(op == 2) std::cout<<" Case: Normal (-65505,65505) * Normal (-65505,65505)"<<std::endl;
            std::uniform_real_distribution<> dist_1a(-65505,65505);
            std::uniform_real_distribution<> dist_1b(-65505,65505);
            dist1 = dist_1a;
            dist2 = dist_1b;            
        } else if(j == 5) {
            if(op == 0)      std::cout<<" Case: Normal (-6550,6550) + Normal (-6550,6550)"<<std::endl;
            else if(op == 1) std::cout<<" Case: Normal (-6550,6550) - Normal (-6550,6550)"<<std::endl;
            else if(op == 2) std::cout<<" Case: Normal (-6550,6550) * Normal (-6550,6550)"<<std::endl;            
            std::uniform_real_distribution<> dist_1a(-6550,6550);
            std::uniform_real_distribution<> dist_1b(-6550,6550);
            dist1 = dist_1a;
            dist2 = dist_1b;            
        } else if(j == 6) {
            if(op == 0)      std::cout<<" Case: Normal (-655,655) + Normal (-655,655)"<<std::endl;
            else if(op == 1) std::cout<<" Case: Normal (-655,655) - Normal (-655,655)"<<std::endl;
            else if(op == 2) std::cout<<" Case: Normal (-655,655) * Normal (-655,655)"<<std::endl;        
            std::uniform_real_distribution<> dist_1a(-655,655);
            std::uniform_real_distribution<> dist_1b(-655,655);
            dist1 = dist_1a;
            dist2 = dist_1b;            
        } else if(j == 7) {
            if(op == 0)      std::cout<<" Case: Normal (-65,65) + Normal (-65,65)"<<std::endl;
            else if(op == 1) std::cout<<" Case: Normal (-65,65) - Normal (-65,65)"<<std::endl;
            else if(op == 2) std::cout<<" Case: Normal (-65,65) * Normal (-65,65)"<<std::endl;            
            std::uniform_real_distribution<> dist_1a(-65,65);
            std::uniform_real_distribution<> dist_1b(-65,65);
            dist1 = dist_1a;
            dist2 = dist_1b;            
        } else if(j == 7) {
            if(op == 0)      std::cout<<" Case: Normal (-6,6) + Normal (-6,6)"<<std::endl;
            else if(op == 1) std::cout<<" Case: Normal (-6,6) - Normal (-6,6)"<<std::endl;
            else if(op == 2) std::cout<<" Case: Normal (-6,6) * Normal (-6,6)"<<std::endl;            
            std::uniform_real_distribution<> dist_1a(-6,6);
            std::uniform_real_distribution<> dist_1b(-6,6);
            dist1 = dist_1a;
            dist2 = dist_1b;
        } else if(j == 8) {
            if(op == 0)      std::cout<<" Case: Normal (..,..) + SubNormal"<<std::endl;
            else if(op == 1) std::cout<<" Case: Normal (..,..) - SubNormal"<<std::endl;
            else if(op == 2) std::cout<<" Case: Normal (..,..) * SubNormal"<<std::endl;
            ...
            if(op == 0)      std::cout<<" Case: SubNormal + SubNormal"<<std::endl;
            else if(op == 1) std::cout<<" Case: SubNormal - SubNormal"<<std::endl;
            else if(op == 2) std::cout<<" Case: SubNormal * SubNormal"<<std::endl;            
    ...
    for(uint64_t i=0;i<iter;i++) {
        ...
        float fp32_c;
        if(op == 0)      fp32_c = fp32_a + fp32_b;
        else if(op == 1) fp32_c = fp32_a - fp32_b;
        else if(op == 2) fp32_c = fp32_a * fp32_b;
        ...
        FP16g fp16g_c(fp16(0));        
        if(op == 0)      fp16g_c = fp16g_a + fp16g_b;
        else if(op == 1) fp16g_c = fp16g_a - fp16g_b;
        else if(op == 2) fp16g_c = fp16g_a * fp16g_b;

        FP16 fp16_a(uint16_t(0));
        FP16 fp16_b(uint16_t(0));
        fp16_a = fp16_u(fp32_a);
        fp16_b = fp16_u(fp32_b); 
        FP16 fp16_c(uint16_t(0));       
        if(op == 0)      fp16_c = fp16_a + fp16_b;   
        else if(op == 1) fp16_c = fp16_a - fp16_b;   
        else if(op == 2) fp16_c = fp16_a * fp16_b;   
